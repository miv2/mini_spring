...
public class CommentController {
    ...
    public ApiResult<CommentResponse> createComment(
            ...
            @Parameter(hidden = true) @AuthenticationPrincipal MemberAdapter memberAdapter) {
        return ApiResult.success(commentService.createComment(request, memberAdapter.getMember()));
    }
    ...
    public ApiResult<CommentResponse> updateComment(
            ...
            @Parameter(hidden = true) @AuthenticationPrincipal MemberAdapter memberAdapter) {
        return ApiResult.success(commentService.updateComment(commentId, request, memberAdapter.getMember()));
    }
